<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    if ($status["name"] == "Released") {
      $obj = new AiRecord();
      $obj->releaseRecord($_GET["record_id"], $status["status_id"], $_SESSION["account_id"], $remarks);
    } else {
      $obj = new AiRecord();
      $obj->updateRecord($_GET["record_id"], $status["status_id"], $_SESSION["account_id"], $remarks);
    }
          ...
          <form id="record-form" name="record-form" action="#" method="post">
            <div class="row">
              ...
              <div class="col-md-12 d-flex">
                <div class="card flex-fill">
                  <div class="card-header">
                    <h4 class="card-title">AI Information</h4>
                    <div class="card-tools">
                      <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                        <i class="fas fa-minus"></i>
                      </button>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="memorandum-no" type="text" class="form-control" readonly value="<?php echo $record["memorandum_no"]; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
