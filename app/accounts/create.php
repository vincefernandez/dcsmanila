<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    $obj = new Role();
    $role = $obj->getRoleByName($_POST["role"]);

    $obj = new Account();
    $obj->addAccount($first_name, $middle_name, $last_name, $suffix, $birthdate, $contact_no, $position,
      $employment_date, $avatar_path, $role["role_id"], $email, $password);
    
    $_SESSION["toastr"] = array("type" => "success", "message" => "Account has been created!");
                  ...
                  <div class="card-body">
                    <div class="d-flex flex-column align-items-center text-center">
                      <div class="profile-container mt-2 mb-4">
                        <img id="avatar" name="avatar" src="<?php echo $avatar_path; ?>" alt="" class="rounded-circle img-thumbnail">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                          <label>Role</label>
                          <select id="role" name="role" class="form-control select2bs4" style="width: 100%;">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="password" name="password" type="text" class="form-control" readonly placeholder="Password" value="<?php echo uniqid(); ?>">
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="middle-name" name="middle-name" type="text" class="form-control" placeholder="Middle Name">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Suffix</label>
                          <input id="suffix" name="suffix" type="text" class="form-control" placeholder="Suffix (e.g. Sr., Jr., III)">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div id="birthdate-group" class="input-group date" data-target-input="nearest">
                            <input name="birthdate" type="text" class="form-control datetimepicker-input" data-target="#birthdate-group"
                              data-toggle="datetimepicker" placeholder="mm/dd/yyyy"/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input id="contact-no" name="contact-no" type="text" class="form-control" placeholder="Contact No">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
