<?php
  ...
  if (isset($_POST["submit"])) {
    ...
    if ($status["name"] == "Released") {
      $obj = new CavRecord();
      $obj->releaseRecord($_GET["record_id"], $status["status_id"], $_SESSION["account_id"], $school, $district, $year, $remarks);
    } else {
      $obj = new CavRecord();
      $obj->updateRecord($_GET["record_id"], $status["status_id"], $_SESSION["account_id"], $school, $district, $year, $remarks);
    }
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input name="district" type="text" class="form-control" value="<?php echo $record["district"]; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Year</label>
                          <input name="year" type="text" class="form-control" value="<?php echo $record["year"]; ?>">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
